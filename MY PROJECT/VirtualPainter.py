...
brushThickness = 35
eraserThickness = 200
drawColor=(255,69,0)#setting orange color
...
while True:
    ...
    lmList = detector.findPosition(img, draw=False)#using function to find specific landmark position,draw false means no circles on landmarks
